...
@section('title', 'Co-Assistant Dashboard | JSHB')
    ...
    <div class="dashboard-hero-card">
        <div>
            <div class="dashboard-hero-kicker">
                Co-Assistant Quick View
            </div>

            @php
                $mdUser = \App\Models\User::find(Auth::user()->assistant_to_id);
                $mdName = $mdUser ? $mdUser->name : 'MD';
            @endphp
            <h2 class="dashboard-hero-title" style="text-transform: capitalize;">Co-Assistant to {{ $mdName }}</h2>
    ...
    <div class="card mt-4" style="margin-top: 20px;">
        <div class="card-head">
            ...
            <div class="card-actions">
                <a href="{{ route('coassistant.applications.index') }}" class="btn-primary" style="padding: 6px 12px; font-size: 14px;">View All</a>
            </div>
        </div>
            ...
            <table class="ep-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('coassistant.applications.show', $app) }}" class="btn-primary" style="padding: 4px 10px; font-size: 12px; display: inline-block; text-decoration: none;">Review</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
