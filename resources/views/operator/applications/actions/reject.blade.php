...
<div class="compact-wrapper">
    <div class="compact-card col-span-12">
        <div class="compact-card-header header-red">
            ...
            <a href="{{ route('operator.applications.show', $application) }}" class="btn btn-outline-danger btn-sm" style="background: rgba(255,255,255,0.7); font-weight: 600; color: #721c24; border-color: #721c24;"><i class="fa-solid fa-arrow-left"></i> Back to Review</a>
        </div>
