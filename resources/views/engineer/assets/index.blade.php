            ...
            <div style="grid-column: span 4;">
                <div class="compact-card">
                    ...
                    <div class="compact-card-body">
                        <form action="{{ route('engineer.assets.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="asset-grid">
                                @foreach($assets as $asset)
                                    <div class="asset-item">
                                        ...
                                        <form action="{{ route('engineer.assets.destroy', $asset->id) }}" method="POST" onsubmit="return confirm('Delete this asset permanently?');">
                                            @csrf
                                            @method('DELETE')
