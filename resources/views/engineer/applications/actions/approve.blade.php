...
<div class="compact-wrapper">
    <div class="compact-card col-span-12">
        <div class="compact-card-header header-green">
            ...
            <a href="{{ route('engineer.applications.show', $application) }}" class="btn btn-outline-success btn-sm" style="background: rgba(255,255,255,0.7); font-weight: 600; color: #155724; border-color: #155724;"><i class="fa-solid fa-arrow-left"></i> Back to Review</a>
        </div>
