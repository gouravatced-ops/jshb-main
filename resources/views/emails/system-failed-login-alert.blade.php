...
<head>
    ...
    <style>
        ...
        .header {
            ...
            display: flex;
            align-items: center;
            border-bottom: 4px solid #dc2626; /* Red border for critical */
        }
        ...
        /* ─── Red accent bar ─── */
        .accent-bar {
            background: #dc2626; /* Red for alert */
            padding: 8px 20px;
            color: #ffffff;
            font-size: 12px;
            font-weight: 700;
...
<body>
    <div class="email-wrapper">
        ...
        <div class="body-content">
            ...
            <p class="warning-text">⚠ Warning: Suspicious login activity detected.</p>
            <p class="message-text">A user or IP has failed to login <strong>{{ $attempts }} times</strong> consecutively. Here are the details:</p>

            <table class="details-table">
                <tr>
                    <th>Attempted Email</th>
                    <td>{{ $emailAttempted ?? 'Unknown' }}</td>
                </tr>
                <tr>
                    <th>IP Address</th>
                    <td>{{ $ipAddress }}</td>
