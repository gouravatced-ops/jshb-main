        ...
        <table class="ep-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route($routePrefix . '.applications.show', $app) }}" class="btn-primary" style="padding: 6px 12px; font-size: 13px; text-decoration: none; background: #475569;">View Details</a>
                    </td>
                </tr>
                @empty
