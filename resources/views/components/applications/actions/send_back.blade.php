@props(['application', 'routePrefix', 'sendBackOptions' => []])
    ...
    <div class="compact-card col-span-12">
        <div class="compact-card-header header-yellow" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div>
                ...
                <a href="{{ route($routePrefix . '.applications.show', $application) }}" class="btn btn-outline-warning btn-sm" style="background: rgba(255,255,255,0.7); font-weight: 600; color: #856404; border-color: #856404;"><i class="fa-solid fa-arrow-left"></i> Back to Review</a>
            </div>
        </div>
