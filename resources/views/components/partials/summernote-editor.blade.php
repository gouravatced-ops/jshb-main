...
<script>
    $(document).ready(function() {
        $('#summernote').summernote({
            height: 350,
            placeholder: 'Write your official noting here... You can type in English or select Hindi for Hindi typing.',
            fontNames: ['Arial', 'Arial Black', 'Comic Sans MS', 'Courier New', 'KrutiDev011', 'notosansdevanagari'],
            fontNamesIgnoreCheck: ['KrutiDev011', 'notosansdevanagari'],
                ...
                onInit: function() {
                    ...
                    setTimeout(function() {
                        $('.note-dropdown-menu a').each(function() {
                            if ($(this).attr('data-value') === 'KrutiDev011' || $(this).text().trim() === 'KrutiDev011' || $(this).attr('data-value') === 'notosansdevanagari' || $(this).text().trim() === 'notosansdevanagari') {
