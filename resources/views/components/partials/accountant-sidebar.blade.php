@if($sidebarUser?->role === 'accountant')
<div class="nav-item-wrap">
    <a class="nav-link-custom {{ request()->routeIs('accountant.dashboard') ? 'active' : '' }}" href="{{ route('accountant.dashboard') }}">
...
<div class="nav-item-wrap">
    <a class="nav-link-custom {{ request()->routeIs('accountant.profile') ? 'active' : '' }}" href="{{ route('accountant.profile') }}">
