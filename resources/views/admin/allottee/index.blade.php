    ...
    <div class="modern-card-header">
        <div class="header-flex">
            ...
            <div class="flex items-center">
                <a href="#">
                    <button class="btn btn-info" style="background: linear-gradient(135deg, #ce3d04, #ee5121) !important; color:white;padding: 6px 24px; border-radius: 2px;">
...
<script>
    const StepManager = {
        ...
        loadStep: function(step) {
            ...
            if (stepContent) {
                stepContent.innerHTML = '<div class="load-state"><div class="load-ring"></div><span>Loading...</span></div>';
            }
            ...
            fetch(this.config.steps[this.config.currentStep], {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        const msg = data.errors ? Object.values(data.errors).flat().join('<br>') : (data.message || 'Error saving data.');
