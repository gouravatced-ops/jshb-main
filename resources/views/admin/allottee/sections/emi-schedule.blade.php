...
@php
    ...
    $schedules = $emiAccount
        ? \App\Models\AllotteeEmiSchedule::where('emi_account_id', $emiAccount->id)->orderBy('emi_no')->paginate(12)
        : collect();
    ...
    @if ($emiAccount)
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body p-0">
                        ...
                        <tbody>
                            ...
                            @forelse($schedules as $schedule)
                                <tr>
                                    ...
                                    <td>
                                        <strong>
                                            EMI-{{ str_pad($schedule->emi_no, 2, '0', STR_PAD_LEFT) }}
                                        </strong>
                                    </td>
                                    ...
                                    <td>
                                        ₹ {{ number_format($schedule->admin_charge, 2) }}
                                    </td>
                ...
                @if ($emiAccount && method_exists($schedules, 'links'))
