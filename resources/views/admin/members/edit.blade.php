                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group" id="subDivisionGroup" style="display:none;">
                                ...
                                <select name="sub_division_id" id="subDivisionSelect" class="form-select">
                                    ...
                                    @foreach($subDivisions as $subDivision)
                                        <option value="{{ $subDivision->id }}" data-division="{{ $subDivision->division_id }}" {{ old('sub_division_id', $member->sub_division_id) == $subDivision->id ? 'selected' : '' }} style="display:none;">
                                            {{ $subDivision->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group" style="display:flex; align-items:center; gap: 10px; margin-top: 30px;">
                                <input type="checkbox" name="is_default" id="isDefault" value="1" {{ old('is_default', $member->is_default) ? 'checked' : '' }} style="width:20px; height:20px;">
