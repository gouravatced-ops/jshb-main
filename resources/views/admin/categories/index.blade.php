...
<div class="card">
    ...
    <div class="card-head">
        ...
        <div class="card-actions">
            <form method="GET" action="{{ route('admin.categories.index') }}" class="search-box" onsubmit="return false;">
                <i class="fa-solid fa-magnifying-glass"></i>
                <input type="text" id="categoriesSearchInput" name="search" value="{{ $search }}" placeholder="Search categories..." autocomplete="off">
            </form>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-btns">
                                <a class="action-btn edit" href="{{ route('admin.categories.edit', $cat) }}" title="Edit">
    ...
    @if($categories->total() > 0)
        <div class="table-pagination" id="categoriesPagination">
            ...
            <div class="pagination-btns">
                ...
                @else
                    <a class="pag-btn" href="{{ $categories->previousPageUrl() }}"><i class="fa-solid fa-chevron-left"></i></a>
                @endif

                @foreach($categories->getUrlRange(1, $categories->lastPage()) as $page => $url)
                    <a class="pag-btn {{ $page === $categories->currentPage() ? 'active' : '' }}" href="{{ $url }}">{{ $page }}</a>
                @endforeach

                @if($categories->hasMorePages())
                    <a class="pag-btn" href="{{ $categories->nextPageUrl() }}"><i class="fa-solid fa-chevron-right"></i></a>
                @else
