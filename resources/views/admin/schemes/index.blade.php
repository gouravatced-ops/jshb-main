                ...
                <div class="scheme-card" data-scheme-id="{{ $scheme->id }}">
                        ...
                        <div class="scheme-title">
                            ...
                            <div class="scheme-name-section">
                                ...
                                <div class="scheme-code">
                                    <i class="fa-solid fa-code"></i> Code: {{ $scheme->scheme_code }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="scheme-body">
                        ...
                        <div>
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-value price-value">₹{{ number_format($scheme->total_units * 500000, 2) }}</span>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="info-row">
                                ...
                                <span class="info-value">{{ optional($scheme->scheme_start_date)->format('d/m/Y') ?: '—' }}</span>
                            </div>
                            <div class="info-row">
                                <span class="info-label"><i class="fa-regular fa-calendar-check"></i> End Date</span>
                                <span class="info-value">{{ optional($scheme->scheme_end_date)->format('d/m/Y') ?: '—' }}</span>
                            </div>
                            <div class="info-row">
                    ...
                    <div class="scheme-footer">
                        <div class="created-info">
                            <i class="fa-regular fa-calendar-alt"></i> Created: {{ optional($scheme->created_at)->format('d/m/Y') ?: '-' }}
                            @if($scheme->creator)
                        ...
                        <div class="action-btns">
                            ...
                            <a class="action-btn blocks" href="#" title="View Blocks">
            ...
            <div class="scheme-card" data-scheme-id="${scheme.id}">
                <div class="scheme-header">
                    <div class="scheme-title">
                        ...
                        <div class="scheme-name-section">
                            ...
                            <div class="scheme-code">
                                <i class="fa-solid fa-code"></i> Code: ${escapeHtml(scheme.scheme_code)}
                            </div>
                        </div>
                    </div>
                    <div class="scheme-badges">
                ...
                <div class="scheme-body">
                    ...
                    <div>
                        ...
                        <div class="info-row">
                            <span class="info-label"><i class="fa-solid fa-indian-rupee-sign"></i> Est. Price</span>
                            <span class="info-value price-value">₹${formatNumber(scheme.total_units * 500000)}</span>
                        </div>
                    </div>
                ...
                <div class="scheme-footer">
                    ...
                    <div class="action-btns">
                        ...
                        <a class="action-btn blocks" href="/admin/schemes/${scheme.id}/blocks" title="View Blocks">
                            <i class="fa-solid fa-layer-group"></i> Blocks
                        </a>
